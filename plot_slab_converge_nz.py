#!/usr/bin/env python
#
# Code to make a plot to make the nz convergence figure
#
...
if __name__ == "__main__":
    ...
    plot_indiv_comp(ax[0], ['1e0','1e1'], ['090'], 'Total',
    ...
    minmax_y_vals = np.array([1e-4,20])
